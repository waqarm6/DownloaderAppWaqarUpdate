...
import static com.abtech.mp3.mp4.videodownloader.utils.Constants.STARTFOREGROUND_ACTION;
import static com.abtech.mp3.mp4.videodownloader.utils.Constants.STOPFOREGROUND_ACTION;
...
public class ClipboardMonitor extends Service {
    ...
    public void onTaskRemoved(Intent rootIntent) {
        ...
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.M) {
            restartServicePendingIntent = PendingIntent.getBroadcast(getApplicationContext(), 1, restartServiceIntent, PendingIntent.FLAG_IMMUTABLE | PendingIntent.FLAG_ONE_SHOT);
        }else {
            restartServicePendingIntent = PendingIntent.getBroadcast(getApplicationContext(), 1, restartServiceIntent,  PendingIntent.FLAG_ONE_SHOT);
