...
import static com.abtech.mp3.mp4.videodownloader.R.string.youneedloginfirest;

@Keep
public class AllDownloadProfileActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listAllProfilePostsInstagramUserAdapter = new ListAllProfilePostsInstagramUserAdapter(AllDownloadProfileActivity.this, storyModelInstaItemList);
        binding.recyclerviewProfileLong.setLayoutManager(new GridLayoutManager(AllDownloadProfileActivity.this, 3));
        ...
        binding.recyclerviewProfileLong.addOnScrollListener(new RecyclerView.OnScrollListener() {
            ...
            public void onScrollStateChanged(RecyclerView recyclerView, int newState) {
                ...
                if (!recyclerView.canScrollVertically(1) && newState == RecyclerView.SCROLL_STATE_IDLE) {
                    ...
                    Toast.makeText(AllDownloadProfileActivity.this, R.string.taptoloadmore, Toast.LENGTH_SHORT).show();
    ...
    void loadAllprofileData(String username, String pkid) {
        ...
        SharedPrefsForInstagram sharedPrefsFor = new SharedPrefsForInstagram(AllDownloadProfileActivity.this);
        Map<String, String> map = (Map<String, String>) sharedPrefsFor.getPreference();
        if (map != null) {
...
//                                System.out.println("hvjksdhfhdkd followed by  " + root.getGraphql().getUser().getEdge_followed_by().getCount());
                                ...
                                Glide.with(AllDownloadProfileActivity.this).load(userdata.getString("profile_pic_url")).into(binding.profileLongCircle);
