...
import com.abtech.mp3.mp4.videodownloader.adapters.ProfileBulkLayoutAdapter;
import com.abtech.mp3.mp4.videodownloader.databinding.ActivityInstagramBulkDownloaderBinding;
import com.abtech.mp3.mp4.videodownloader.models.bulkdownloader.UserUser;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.searchinstaprofile.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextSubmit(String query) {
                ...
                if (map != null) {
                    String cookie = "ds_user_id=" + map.getPREFERENCE_USERID()+ "; sessionid=" + map.getPREFERENCE_SESSIONID();
