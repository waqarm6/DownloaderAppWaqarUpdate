...
import static com.abtech.mp3.mp4.videodownloader.utils.Constants.DlApisUrl;
import static com.abtech.mp3.mp4.videodownloader.utils.Constants.DlApisUrl2;
...
import com.abtech.mp3.mp4.videodownloader.adapters.QualityBottomsheetAdapter;
import com.abtech.mp3.mp4.videodownloader.models.DlApismodels.DLDataParser;
import com.abtech.mp3.mp4.videodownloader.models.DlApismodels.Format;
import com.abtech.mp3.mp4.videodownloader.models.DlApismodels.Video;
import com.abtech.mp3.mp4.videodownloader.snapchatstorysaver.SnapChatBulkStoryDownloader;
import com.abtech.mp3.mp4.videodownloader.tiktok_methods.FacebookDownloadCloudBypassWebview_method_1;
import com.abtech.mp3.mp4.videodownloader.tiktok_methods.TikTokDownloadCloudBypassWebview_method_3;
import com.abtech.mp3.mp4.videodownloader.tiktok_methods.TikTokDownloadCloudBypassWebview_method_6;
import com.abtech.mp3.mp4.videodownloader.tiktok_methods.TikTokDownloadCloudBypassWebview_method_7;
...
//                                try {
//                                    con = (HttpURLConnection) (new URL(finalUrl2).openConnection());
//
...
//
//
//                                    AndroidNetworking.get("http://api2.musical.ly/aweme/v1/aweme/detail/?aweme_id=" + location.split("/")[5].split("\\?")[0])
...
//
//                                                        matag = jsonObject.getJSONObject("aweme_detail").getJSONObject("video").getJSONObject("play_addr").getJSONArray("url_list").getString(2);
//                                                        if (matag.contains("http")) {
//                                                            System.out.println("wojfdjhfdjh " + matag);
//                                                            new downloadFile().Downloading(MainActivity.this, matag, "Tiktok_" + System.currentTimeMillis(), ".mp4");
//                                                        } else {
...
//                RequestBody body = RequestBody.create(mediaType, "{\n    \"url\":\"https://vm.tiktok.com/ZGJUevKRf/\"\n}");
//                Request request = new Request.Builder()
//                        .url("https://tdl.heran.xyz/api/download")
//                        .method("POST", body)
...
//                        .build();
//                Request request = new Request.Builder()
//                        .url("https://server1.majhcc.xyz/api/tk?url=https://vm.tiktok.com/ZSQTnNWu/")
//                        .method("GET", null)
//                        .build();
//                Response response = client.newCall(request).execute();
//TODO 3
...
//                        .build();
//                Request request = new Request.Builder()
//                        .url("http://toolav.herokuapp.com/id/?video_id=6877117764197256449")
//                        .method("GET", null)
//                        .build();
//                Response response = client.newCall(request).execute();
//
...
//                        .build();
//                Request request = new Request.Builder()
//                        .url("https://www.tiktokdownloader.org/check.php?v=" + finalUrl2 + "&t=1656190672901")
//                        .method("GET", null)
//                        .build();
                                        ...
                                        AndroidNetworking.get("http://api2.musical.ly/aweme/v1/aweme/detail/?aweme_id=" + location.split("/")[5].split("\\?")[0])
                                                ...
                                                .getAsJSONObject(new JSONObjectRequestListener() {
                                                    ...
                                                    public void onError(ANError error) {
                                                        ...
                                                        AndroidNetworking.get("https://youtube4kdownloader.com/ajax/getLinks.php?video=" + finalUrl2 + "&rand=6acbe95e6bab6")
                                                                .setPriority(Priority.MEDIUM)
//                                            .addHeaders("Cookie", "langc=en")
                                                                .build()
                                                                .getAsJSONObject(new JSONObjectRequestListener() {
                                                                    @Override
                                                                    public void onResponse(JSONObject response) {

                                                                        System.out.println("wojfdjhfdjhtik yyyy " + response);
                                                                        ...
                                                                        try {
                                                                            ...
                                                                            try {
                                                                                ...
                                                                                String res = response3.body().string();
                                                                                ...
                                                                                for (Element element : elements) {
                                                                                    ...
                                                                                    if (!element.attr("href").contains("https://play.google.com") && element.attr("href").contains("tiktok") && element.attr("href").length() > 150) {
                            ...
                            public void run() {
                                ...
                                try {
                                    ...
                                    Request request = new Request.Builder()
                                            ...
                                            .addHeader("user-agent", "Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/99.0.4844.84 Safari/537.36")
                                            .addHeader("x-requested-with", "XMLHttpRequest")
                                            .build();
                                    Response response = client.newCall(request).execute();
...
//
                ...
                //      new CallLikeeDataOld().execute(url);
                    ...
                    try {
                        ...
                        if (finalUrl3[0].contains("likee.video/v/")) {
                            try {
                                ...
                                String line2 = myres.substring(myres.indexOf("https"), myres.indexOf("';"));
                                finalUrl3[0] = line2;
                            } catch (Exception e) {
                                e.printStackTrace();
                            }
...
//                                            String fUrl;
//                                            if(finalUrl1.contains("https://m.facebook.com")){
//                                               fUrl =  finalUrl1.replace("https://m.facebook.com","https://facebook.com");
//                                            }else {
//                                                fUrl =finalUrl1;
//                                            }
                                            ...
                                            RequestBody body = new MultipartBody.Builder().setType(MultipartBody.FORM)
                                                    ...
                                                    .build();
                                            Request request = new Request.Builder()
                                                    .url("https://x2download.com/api/ajaxSearch/facebook")
                                                    .method("POST", body)
                                                    .build();
                                            Response response = client.newCall(request).execute();

                                            String ressff = response.body().string();
                                            System.out.println("myurliss resss = " + ressff);

                                            JSONObject document = new JSONObject(ressff);
                                            dismissMyDialog();

                                            if (!document.getJSONObject("links").getString("hd").equals("")) {
                                            ...
                                            } else if (!document.getJSONObject("links").getString("sd").equals("")) {
                                                String nametitle = "Facebook_" +
                                                        System.currentTimeMillis();

                                                DownloadFileMain.startDownloading(Mcontext, document.getJSONObject("links").getString("sd"), nametitle, ".mp4");
                ...
                new Thread(new Runnable() {
                    ...
                    public void run() {
                        try {
                            ...
                            Document document;
                            try {
                                HttpURLConnection con = (HttpURLConnection) (new URL(finalUrl4).openConnection());
                                ...
                                if (location.contains("?")) {
                                    ...
                                    document = Jsoup.connect("https://www.pinterest.com/pin/" + location.split("/")[4]).userAgent("Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/102.0.5005.115 Safari/537.36").get();

                                } else {
                                    document = Jsoup.connect(location).userAgent("Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/102.0.5005.115 Safari/537.36").get();
                                ...
                                document = Jsoup.connect(finalUrl4).userAgent("Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/102.0.5005.115 Safari/537.36").get();
...
//                            VideoUrl = "";
    ...
    public static class CallJoshData extends AsyncTask<String, Void, Document> {
        ...
        //https://stream.coolfie.io/stream/prod-ugc-contents/308049f5075587c4/900b428796666377/308049f5075587c4900b428796666377_wmj_720.mp4
        public Document doInBackground(String... strArr) {
            try {
                ...
                if (!html.equals("")) {
                    ...
                    if (this.VideoUrl != null && !this.VideoUrl.equals("")) {
                        try {
                            ...
                            String myurldocument = VideoUrl.replace("_wmj_480.mp4", "_wmj_720.mp4");
